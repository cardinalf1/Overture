...
import { Plus, Trash2, User, Calendar, CheckSquare, ListTodo } from 'lucide-react';
          ...
          >
            ...
            <div className="space-y-1">
              ...
              <select
                ...
                className="w-full bg-zinc-950 border border-zinc-900 rounded px-3 py-2 text-xs font-mono text-zinc-200 focus:outline-none"
              >
